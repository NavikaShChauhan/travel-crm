/**
 * Mock data for the "notifications" module.
 * -----------------------------------------------------------------------
 ...
 * relevant page(s) to call `services/notifications.service.js` instead —
 * no page/component code should need to change beyond that swap.
 *
 * TODO: replace with actual API-backed data once
 * `services/notifications.service.js` is implemented.
 */
